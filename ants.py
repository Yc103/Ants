...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while True:
            if(curr == None):
                return None
            if curr.is_hive or ind > self.upper_bound:
                return None
            if curr.bees:
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8a
        "*** YOUR CODE HERE ***"
        if(self.ant_contained != None or other.is_container == True):
            return False
        return True
        # END Problem 8a
...
# END Problem 12
    ...
    # BEGIN Problem 12
    implemented = True 
    health = 1  # Change to True to view in the GUI
    # END Problem 12
    ...
    def action(self, gamestate):
        ...
        while(True):
            ...
            if(tmp.ant == None):
                tmp = tmp.exit
                continue
            elif(tmp.ant.is_container == True and tmp.ant.ant_contained != None):
